...
export default function Index (projects, queryParams = {}) {
    ...
    const searchFieldChanged = (name, value) => {
        let updatedQueryParams = JSON.parse(JSON.stringify(queryParams)); // Deep copy to ensure mutability
        ...
        router.get(route("project.index"), { ...updatedQueryParams });
    };
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        ...
                        <Pagination links={projects.projects.meta.links} />
                    </div>
                </div>
            </div>
        </AuthenticatedLayout>
